...
NDiplomacy = {
	...
	TENSION_TIME_SCALE_START_DATE = "1952.1.1.12",	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
